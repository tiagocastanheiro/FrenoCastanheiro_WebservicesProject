...
namespace WindowsFormsAppWebServicesTest.MSSQLServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MSSQLServiceReference.IMSSQLService")]
    public interface IMSSQLService {
        ...
        WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account DisplayAccountByUsername(string username);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSSQLService/DisplayAccountByUsername", ReplyAction="http://tempuri.org/IMSSQLService/DisplayAccountByUsernameResponse")]
        System.Threading.Tasks.Task<WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account> DisplayAccountByUsernameAsync(string username);
        ...
        WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account DisplayAccountByUID(int UID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMSSQLService/DisplayAccountByUID", ReplyAction="http://tempuri.org/IMSSQLService/DisplayAccountByUIDResponse")]
        System.Threading.Tasks.Task<WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account> DisplayAccountByUIDAsync(int UID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMSSQLServiceChannel : WindowsFormsAppWebServicesTest.MSSQLServiceReference.IMSSQLService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MSSQLServiceClient : System.ServiceModel.ClientBase<WindowsFormsAppWebServicesTest.MSSQLServiceReference.IMSSQLService>, WindowsFormsAppWebServicesTest.MSSQLServiceReference.IMSSQLService {
        ...
        public WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account DisplayAccountByUsername(string username) {
            return base.Channel.DisplayAccountByUsername(username);
        }
        
        public System.Threading.Tasks.Task<WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account> DisplayAccountByUsernameAsync(string username) {
            return base.Channel.DisplayAccountByUsernameAsync(username);
        }
        
        public WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account DisplayAccountByUID(int UID) {
            return base.Channel.DisplayAccountByUID(UID);
        }
        
        public System.Threading.Tasks.Task<WindowsFormsAppWebServicesTest.MSSQLServiceReference.Account> DisplayAccountByUIDAsync(int UID) {
